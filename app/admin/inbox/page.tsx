...
import BulkStoryActions from './bulk-actions'
...
export default async function StoryInbox() {
  ...
  return (
    <main className="site">
      <header className="header"><div className="header-inner"><Link className="brand" href="/admin">READ-A-BRIEF <span>/ OPERATIONS</span></Link><nav className="nav"><Link href="/admin">Dashboard</Link><Link href="/admin/sources">Sources</Link><Link href="/admin/briefs">Briefings</Link><Link href="/">Public site</Link></nav></div></header>
